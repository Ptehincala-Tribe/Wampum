...
contract(newFunction(), function (accounts) {
  ...
  it("should call a function that depends on a linked library", function () {
    ...
    return Wampum.deployed().then(function (instance) {
      ...
      WampumBalance = parseInt(outCoinBalance);
      return Wam.getBalanceInEth.call(accounts[0]);
    }).then(function (outCoinBalanceEth) {
      WampumWamBalance = parseInt(outCoinBalanceEth);
    }).then(function () {
...
function Wampum() {
  return "should put 10000 Wampum in the first account";
}
