...
module.exports = {
  ...
  parseRawTransactionResponse: function parseRawTransactionResponse(rawTransactionResponse, packaged, address, privateKey, cost, callback) {
    if (this.debug.broadcast) {
  ...
  submitRawTransaction: function submitRawTransaction(packaged, address, privateKey, callback) {
  ...
  setNonceThenSubmitRawTransaction: function setNonceThenSubmitRawTransaction(packaged, address, privateKey, callback) {
    var self = this;
    if (packaged.nonce) {
  ...
  packageAndSubmitRawTransaction: function packageAndSubmitRawTransaction(payload, address, privateKey, callback) {
    var self = this;
    if (!payload || payload.constructor !== Object) {
